	...
	public static void main(String[] args) {
		...
		while (repeat) {
			...
			case 2:
				...
				if(x.searchPersonName()<=0) {
					x.getPersons(x.searchPersonName());
					x.getTelephoneNum(x.searchPersonName());
					x.getAddress(x.searchPersonName());
				}
					...
					while (flag1) {
						...
						if (sc.hasNextInt()) {
							...
							case 0:
								...
								break;
							case 1:
								x.getPersons(x.searchPersonName()).setName(sc.next());
								System.out.println(x.getPersons(x.searchPersonName()).getName());
								break;
							case 2:
